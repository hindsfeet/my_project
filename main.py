...
MCCT (initial) / Minnie Cherry Chua Tan 08-Jul-21 Base version coded from scratch by Minnie (MCCT) to update version1 to optimize code if possible
...
"""
# MCCT/MCT/MT is the initial name of Minnie Cherry Chua Tan - same person  as Minnie Tan, without second name (Cherry) and middle name (Chua)
