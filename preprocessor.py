...
# MCCT is the initial name of Minnie Cherry Chua Tan or Minnie Tan same person
        ...
        if method in dir(sklearn.decomposition):
            ...
            if method not in ['LatentDirichletAllocation', 'NMF', 'SparseCoder', 'TruncatedSVD']:
                ...
                if method == 'KernelPCA':
                    ...
                    print(reduce_features.components_.shape)
                    print(len(reduce_features.components_))
